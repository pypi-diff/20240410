# Comparing `tmp/bec_client-1.23.0.tar.gz` & `tmp/bec_client-1.23.1.tar.gz`
...
### Comparing `bec_client-1.23.0/bec_client/beamline_mixin.py` & `bec_client-1.23.1/bec_client/beamline_mixin.py`
