# Comparing `tmp/characterai-1.0.1a1.tar.gz` & `tmp/characterai-1.0.2a1.tar.gz`
...
### Comparing `characterai-1.0.1a1/characterai/pycai/methods/account.py` & `characterai-1.0.2a1/characterai/pycai/methods/account.py`
