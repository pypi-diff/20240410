# Comparing `tmp/chartfactor-5.0.4.tar.gz` & `tmp/chartfactor-5.0.5.tar.gz`
...
### Comparing `chartfactor-5.0.4/chartfactor.egg-info/SOURCES.txt` & `chartfactor-5.0.5/chartfactor.egg-info/SOURCES.txt`
