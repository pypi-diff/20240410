# Comparing `tmp/clean_html_for_llm-1.1.0.tar.gz` & `tmp/clean_html_for_llm-1.2.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "clean_html_for_llm-1.1.0.tar", last modified: Wed Apr 10 08:08:30 2024, max compression
+gzip compressed data, was "clean_html_for_llm-1.2.0.tar", last modified: Wed Apr 10 08:10:05 2024, max compression
```

## Comparing `clean_html_for_llm-1.1.0.tar` & `clean_html_for_llm-1.2.0.tar`

### file list

```diff
@@ -1,13 +1,13 @@
-drwxr-xr-x   0 shubhamraj   (502) staff       (20)        0 2024-04-10 08:08:30.935795 clean_html_for_llm-1.1.0/
--rw-r--r--   0 shubhamraj   (502) staff       (20)     1073 2024-04-10 07:24:00.000000 clean_html_for_llm-1.1.0/LICENSE
--rw-r--r--   0 shubhamraj   (502) staff       (20)     2951 2024-04-10 08:08:30.935681 clean_html_for_llm-1.1.0/PKG-INFO
-drwxr-xr-x   0 shubhamraj   (502) staff       (20)        0 2024-04-10 08:08:30.934955 clean_html_for_llm-1.1.0/clean_html_for_llm/
--rw-r--r--   0 shubhamraj   (502) staff       (20)       69 2024-04-10 07:57:46.000000 clean_html_for_llm-1.1.0/clean_html_for_llm/__init__.py
--rw-r--r--   0 shubhamraj   (502) staff       (20)     1228 2024-04-10 07:59:03.000000 clean_html_for_llm-1.1.0/clean_html_for_llm/clean_html_for_llm.py
-drwxr-xr-x   0 shubhamraj   (502) staff       (20)        0 2024-04-10 08:08:30.935513 clean_html_for_llm-1.1.0/clean_html_for_llm.egg-info/
--rw-r--r--   0 shubhamraj   (502) staff       (20)     2951 2024-04-10 08:08:30.000000 clean_html_for_llm-1.1.0/clean_html_for_llm.egg-info/PKG-INFO
--rw-r--r--   0 shubhamraj   (502) staff       (20)      256 2024-04-10 08:08:30.000000 clean_html_for_llm-1.1.0/clean_html_for_llm.egg-info/SOURCES.txt
--rw-r--r--   0 shubhamraj   (502) staff       (20)        1 2024-04-10 08:08:30.000000 clean_html_for_llm-1.1.0/clean_html_for_llm.egg-info/dependency_links.txt
--rw-r--r--   0 shubhamraj   (502) staff       (20)       19 2024-04-10 08:08:30.000000 clean_html_for_llm-1.1.0/clean_html_for_llm.egg-info/top_level.txt
--rw-r--r--   0 shubhamraj   (502) staff       (20)       38 2024-04-10 08:08:30.935840 clean_html_for_llm-1.1.0/setup.cfg
--rw-r--r--   0 shubhamraj   (502) staff       (20)     1125 2024-04-10 08:08:25.000000 clean_html_for_llm-1.1.0/setup.py
...
### Comparing `clean_html_for_llm-1.1.0/LICENSE` & `clean_html_for_llm-1.2.0/LICENSE`

 * *Files identical despite different names*

### Comparing `clean_html_for_llm-1.1.0/PKG-INFO` & `clean_html_for_llm-1.2.0/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: clean_html_for_llm Version: 1.1.0 Summary: A
...
### Comparing `clean_html_for_llm-1.1.0/clean_html_for_llm/clean_html_for_llm.py` & `clean_html_for_llm-1.2.0/clean_html_for_llm/clean_html_for_llm.py`

 * *Files identical despite different names*

### Comparing `clean_html_for_llm-1.1.0/clean_html_for_llm.egg-info/PKG-INFO` & `clean_html_for_llm-1.2.0/clean_html_for_llm.egg-info/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: clean-html-for-llm Version: 1.1.0 Summary: A
...
### Comparing `clean_html_for_llm-1.1.0/setup.py` & `clean_html_for_llm-1.2.0/setup.py`
