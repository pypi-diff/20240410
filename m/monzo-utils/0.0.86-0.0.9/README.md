# Comparing `tmp/monzo_utils-0.0.86-py3-none-any.whl.zip` & `tmp/monzo_utils-0.0.9-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,42 +1,25 @@
-Zip file size: 37447 bytes, number of entries: 40
...
--rw-r--r--  2.0 unx     9091 b- defN 24-Mar-07 07:07 monzo_utils/lib/monzo_api.py
--rw-r--r--  2.0 unx    25645 b- defN 24-Feb-17 20:45 monzo_utils/lib/monzo_payments.py
--rw-r--r--  2.0 unx    19466 b- defN 24-Feb-17 20:43 monzo_utils/lib/monzo_sync.py
...
--rw-r--r--  2.0 unx    16430 b- defN 24-Apr-10 18:26 monzo_utils/model/payment.py
...
--rwxr-xr-x  2.0 unx      897 b- defN 24-Apr-10 18:26 monzo_utils-0.0.86.data/scripts/monzo-payments
--rwxr-xr-x  2.0 unx    12970 b- defN 24-Apr-10 18:26 monzo_utils-0.0.86.data/scripts/monzo-search
--rwxr-xr-x  2.0 unx     3241 b- defN 24-Apr-10 18:26 monzo_utils-0.0.86.data/scripts/monzo-status
--rwxr-xr-x  2.0 unx      522 b- defN 24-Apr-10 18:26 monzo_utils-0.0.86.data/scripts/monzo-sync
--rw-r--r--  2.0 unx     1078 b- defN 24-Apr-10 18:26 monzo_utils-0.0.86.dist-info/LICENSE
--rw-r--r--  2.0 unx      406 b- defN 24-Apr-10 18:26 monzo_utils-0.0.86.dist-info/METADATA
--rw-r--r--  2.0 unx       92 b- defN 24-Apr-10 18:26 monzo_utils-0.0.86.dist-info/WHEEL
--rw-r--r--  2.0 unx       61 b- defN 24-Apr-10 18:26 monzo_utils-0.0.86.dist-info/top_level.txt
--rw-rw-r--  2.0 unx     3492 b- defN 24-Apr-10 18:26 monzo_utils-0.0.86.dist-info/RECORD
-40 files, 129636 bytes uncompressed, 31785 bytes compressed:  75.5%
...
-Filename: monzo_utils-0.0.86.data/scripts/monzo-payments
+Filename: monzo_utils-0.0.9.data/scripts/monzo-payments
 Comment: 
 
-Filename: monzo_utils-0.0.86.data/scripts/monzo-search
+Filename: monzo_utils-0.0.9.data/scripts/monzo-search
 Comment: 
 
-Filename: monzo_utils-0.0.86.data/scripts/monzo-status
+Filename: monzo_utils-0.0.9.data/scripts/monzo-status
 Comment: 
 
-Filename: monzo_utils-0.0.86.data/scripts/monzo-sync
+Filename: monzo_utils-0.0.9.data/scripts/monzo-sync
 Comment: 
 
-Filename: monzo_utils-0.0.86.dist-info/LICENSE
+Filename: monzo_utils-0.0.9.dist-info/LICENSE
 Comment: 
 
-Filename: monzo_utils-0.0.86.dist-info/METADATA
+Filename: monzo_utils-0.0.9.dist-info/METADATA
 Comment: 
 
-Filename: monzo_utils-0.0.86.dist-info/WHEEL
+Filename: monzo_utils-0.0.9.dist-info/WHEEL
 Comment: 
 
-Filename: monzo_utils-0.0.86.dist-info/top_level.txt
+Filename: monzo_utils-0.0.9.dist-info/top_level.txt
 Comment: 
 
-Filename: monzo_utils-0.0.86.dist-info/RECORD
...
## Comparing `monzo_utils/lib/monzo_payments.py` & `monzo_utils-0.0.9.data/scripts/monzo-payments`
...
## Comparing `monzo_utils-0.0.86.data/scripts/monzo-search` & `monzo_utils-0.0.9.data/scripts/monzo-search`
...
## Comparing `monzo_utils-0.0.86.data/scripts/monzo-status` & `monzo_utils-0.0.9.data/scripts/monzo-status`
...
## Comparing `monzo_utils-0.0.86.dist-info/LICENSE` & `monzo_utils-0.0.9.dist-info/LICENSE`
